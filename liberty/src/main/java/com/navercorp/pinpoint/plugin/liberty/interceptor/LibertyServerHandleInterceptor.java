package com.navercorp.pinpoint.plugin.liberty.interceptor;
...
//import com.navercorp.pinpoint.bootstrap.util.spring.StringUtils;
import com.navercorp.pinpoint.common.trace.AnnotationKey;
import com.navercorp.pinpoint.common.trace.ServiceType;
import com.navercorp.pinpoint.plugin.liberty.LibertyConstants;
import com.navercorp.pinpoint.plugin.liberty.LibertySyncMethodDescriptor;
import com.navercorp.pinpoint.plugin.liberty.util.StringUtils;
...
public class LibertyServerHandleInterceptor  implements AroundInterceptor {

    public static final LibertySyncMethodDescriptor LIBERTY_SYNC_API_TAG = new LibertySyncMethodDescriptor();
    ...
    public LibertyServerHandleInterceptor(TraceContext traceContext, MethodDescriptor descriptor, Filter<String> excludeFilter) {
        this.traceContext = traceContext;
        this.methodDescriptor = descriptor;
        this.excludeUrlFilter = excludeFilter;

        traceContext.cacheApi(LIBERTY_SYNC_API_TAG);
    }
    ...
    public void before(Object target, Object[] args) {
        ...
        try {
            ...
            recorder.recordServiceType(LibertyConstants.LIBERTY_METHOD);
        } catch (Throwable th) {
    ...
    private IRequest getRequest(Object[] args) {
    ...
    private void recordRootSpan(final SpanRecorder recorder, final IRequest request) {
        // root
        recorder.recordServiceType(LibertyConstants.LIBERTY);
        ...
        recorder.recordApi(LIBERTY_SYNC_API_TAG);
